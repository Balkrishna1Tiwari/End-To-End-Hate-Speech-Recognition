...
class PredictionPipeline:
    ...
    def predict(self,best_model_path,text):
        ...
        try:
            ...
            load_model=keras.models.load_model(r"D:\End-to-end-NLP-Project-Implementation-main\artifacts\08_01_2024_00_07_32\ModelTrainerArtifacts\model.h5")
    ...
    def run_pipeline(self,text):
        ...
        try:
            ...
            # best_model_path: str = self.get_model_from_gcloud() 
            predicted_text = self.predict("D:\End-to-end-NLP-Project-Implementation-main\artifacts\08_01_2024_00_07_32\ModelTrainerArtifacts\model.h5",text)
