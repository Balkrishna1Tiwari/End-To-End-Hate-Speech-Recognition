...
class TrainPipeline:
    def __init__(self):
        ...
        self.model_artifacts=ModelTrainerArtifacts
        self.data_transforation_artifacts=DataTransformationArtifacts
    ...
    def run_pipeline(self):
        ...
        try:
            ...
            # model_trainer_artifacts=self.model_artifacts
            # data_transformation_artifacts=self.data_transforation_artifacts 
